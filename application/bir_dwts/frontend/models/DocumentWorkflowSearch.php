...
use frontend\models\DocumentWorkflow;

/**
 * DocumentWorkflowSearch represents the model behind the search form about `frontend\models\DocumentWorkflow`.
 */
class DocumentWorkflowSearch extends DocumentWorkflow
{
    ...
    {
        return [
            [['id', 'document_id', 'employee_id', 'station_desk_id', 'employee_id1'], 'integer'],
