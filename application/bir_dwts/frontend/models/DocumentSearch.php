...
class DocumentSearch extends Document
{
    ...
    {
        return [
            [['id', 'document_category', 'document_priority_id', 'employee_id', 'customer_id', 'company_agency_id'], 'integer'],
            [['document_tracking_number', 'document_name', 'document_description', 'document_target_date', 'document_type', 'document_comment', 'document_image_front_page', 'create_time', 'update_time'], 'safe'],
        ];
    }
