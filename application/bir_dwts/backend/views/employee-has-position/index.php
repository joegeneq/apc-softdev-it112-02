...
<div class="employee-has-position-index">
    ...
    <p>
        <?= Html::button('Create Employee has Position', ['value'=>Url::to('/bir_dwts/backend/web/index.php?r=employee-has-position%2Fcreate'),'class' => 'btn btn-success','id'=>'modalButton']) ?>
    </p>
