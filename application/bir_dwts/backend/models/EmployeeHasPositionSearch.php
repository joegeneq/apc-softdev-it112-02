...
use backend\models\EmployeeHasPosition;

/**
 * EmployeeHasPositionSearch represents the model behind the search form about `backend\models\EmployeeHasPosition`.
 */
class EmployeeHasPositionSearch extends EmployeeHasPosition
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'employee_position_end_date', $this->employee_position_end_date]);
