...
CREATE TABLE IF NOT EXISTS `it112_exercise1`.`city` (
  ...
  PRIMARY KEY (`id`, `province_id1`, `province_region_ID`),
  INDEX `fk_city_province1_idx` (`province_id1` ASC, `province_region_ID` ASC),
  CONSTRAINT `fk_city_province1`
    FOREIGN KEY (`province_id1` , `province_region_ID`)
    REFERENCES `it112_exercise1`.`province` (`id` , `region_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
