...
CREATE TABLE IF NOT EXISTS `it112_exercise1`.`region` (
  ...
  `region.code` VARCHAR(32) NULL,
  `region.description` VARCHAR(32) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `it112_exercise1`.`province` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `province.code` VARCHAR(32) NULL,
  `province.description` VARCHAR(32) NULL,
...
CREATE TABLE IF NOT EXISTS `it112_exercise1`.`city` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `city.code` VARCHAR(32) NULL,
  `city.description` VARCHAR(32) NULL,
