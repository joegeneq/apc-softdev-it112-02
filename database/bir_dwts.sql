...
CREATE TABLE IF NOT EXISTS `bir_dwts`.`employee` (
  ...
  `employee_last_name` VARCHAR(45) NULL,
  `employee_first_name` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `bir_dwts`.`company_agency` (
  ...
  `company_agency_name` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `bir_dwts`.`document_priority` (
  ...
  `document_priority_description` TEXT NULL,
...
-- -----------------------------------------------------
-- Table `bir_dwts`.`document_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bir_dwts`.`document_type` (
  `id` INT NOT NULL,
  `document_type_name` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `bir_dwts`.`document` (
  ...
  INDEX `fk_document_section1_idx` (`section_id` ASC),
  ...
  CONSTRAINT `fk_document_document_type1`
    ...
    REFERENCES `bir_dwts`.`document_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `bir_dwts`.`document_workflow_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bir_dwts`.`document_workflow_status` (
  `id` INT NOT NULL,
  `document_workflow_status_name` VARCHAR(45) NULL,
  `document_workflow_status_description` TEXT NULL,
  `create_time` TIMESTAMP NULL,
  `update_time` DATETIME NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bir_dwts`.`document_workflow` (
  ...
  INDEX `fk_document_workflow_document_status1_idx` (`document_status_id` ASC),
  ...
  CONSTRAINT `fk_document_workflow_employee1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_document_workflow_document_status1`
    FOREIGN KEY (`document_status_id`)
    REFERENCES `bir_dwts`.`document_workflow_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `bir_dwts`.`station_desk_role` (
  ...
  `station_desk_role_description` TEXT NULL,
  `create_time` TIMESTAMP NULL DEFAULT current_timestamp,
  `update_time` DATETIME NULL,
  PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `bir_dwts`.`employee_has_position` (
  ...
  `employee_position_end_date` DATE NULL,
  `create_time` TIMESTAMP NULL,
  `update_time` DATETIME NULL,
  PRIMARY KEY (`id`),
