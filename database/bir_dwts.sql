...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2015 at 01:17 PM
...
CREATE TABLE IF NOT EXISTS `document` (
  ...
  KEY `fk_document_document_category1_idx` (`document_category`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `document_workflow` (
  ...
  KEY `fk_document_workflow_employee1_idx` (`next_receiver`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `station_desk` (
  ...
  `division_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_station_desk_division1_idx` (`division_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
