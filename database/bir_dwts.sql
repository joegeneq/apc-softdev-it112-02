...
-- -----------------------------------------------------
-- Table `bir_dwts`.`document_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bir_dwts`.`document_status` (
  `id` INT NOT NULL,
  `document_status_name` VARCHAR(45) NULL,
  `document_status_description` VARCHAR(45) NULL,
  `create_time` TIMESTAMP NULL,
  `update_time` DATETIME NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bir_dwts`.`document_workflow` (
  ...
  `time_released` TIMESTAMP NOT NULL,
  ...
  CONSTRAINT `fk_document_workflow_document_status1`
    ...
    REFERENCES `bir_dwts`.`document_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
