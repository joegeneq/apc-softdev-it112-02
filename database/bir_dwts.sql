...
-- -----------------------------------------------------
-- Table `bir_dwts`.`division`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bir_dwts`.`division` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bir_dwts`.`employee` (
  ...
  CONSTRAINT `fk_employee_division1`
    ...
    REFERENCES `bir_dwts`.`division` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `bir_dwts`.`company_agency` (
  ...
  `company_agency_full_name` VARCHAR(45) NULL,
  `company_agency_notes` TEXT NULL,
  `create_time` TIMESTAMP NULL DEFAULT current_timestamp,
  `update_time` TIMESTAMP NULL,
  PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `bir_dwts`.`document` (
  ...
  `document_priority` VARCHAR(45) NULL,
  `document_target_date` DATE NULL,
  `document_type` VARCHAR(45) NULL,
  `document_notes` VARCHAR(45) NULL,
  `document_image_front_page` BLOB NULL,
  `create_time` TIMESTAMP NULL DEFAULT current_timestamp,
  `update_time` TIMESTAMP NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_document_employee1_idx` (`encoded_by` ASC),
...
CREATE TABLE IF NOT EXISTS `bir_dwts`.`station_desk` (
  ...
  `division_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_station_desk_division1_idx` (`division_id` ASC),
...
- completed released to customer*/,
  ...
  INDEX `fk_document_workflow_employee1_idx` (`next_receiver` ASC),
...
CREATE TABLE IF NOT EXISTS `bir_dwts`.`station_desk_role` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `station_desk_code` VARCHAR(45) NULL,
  `station_desk_description` VARCHAR(45) NULL,
  `create_time` TIMESTAMP NULL DEFAULT current_timestamp,
  `update_time` TIMESTAMP NULL,
  PRIMARY KEY (`id`));
