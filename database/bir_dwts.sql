...
CREATE TABLE IF NOT EXISTS `bir_dwts`.`station_desk` (
  ...
  `station_desk_notes` VARCHAR(45) NULL,
  `create_time` TIMESTAMP NULL DEFAULT current_timestamp,
  `update_time` TIMESTAMP NULL,
  PRIMARY KEY (`id`));
...
-- -----------------------------------------------------
-- Table `bir_dwts`.`document_wokflow`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bir_dwts`.`document_wokflow` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `document_id` INT NOT NULL,
  `employee_id` INT NOT NULL,
  `station_desk_id` INT NOT NULL,
  `document_wokflow_comments` TEXT NULL,
  `document_wokflow_status` VARCHAR(45) NULL,
